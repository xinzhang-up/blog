...
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="部署" tabindex="-1">部署 <a class="header-anchor" href="#部署" aria-label="Permalink to &quot;部署&quot;">​</a></h3><blockquote><p>完全参考上面的博客</p></blockquote><ol><li><p>新建github仓库</p></li><li><p>调整根路径</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>export default defineConfig({</span></span>
<span class="line"><span>   base: &#39;/blog/&#39;, // 这里将会影响之后生成的根路径</span></span>
<span class="line"><span>  })</span></span></code></pre></div></li><li><p>建立vitepress-starter\\deploy.sh</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#!/usr/bin/env sh</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># Jacqueline712/mondaylab-blog 替换为自己的用户名和对应的仓库名</span></span>
<span class="line"><span># 意思为将master构建后的代码合并到gh-pages分支上，然后在gh-pages分支上部署~</span></span>
<span class="line"><span>git push -f https://github.com/xinzhang-up/blog.git master:gh-pages</span></span>
<span class="line"><span></span></span>
<span class="line"><span>cd -</span></span></code></pre></div></li><li><p>将本地项目推到main分支</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>git init</span></span>
<span class="line"><span>git add .</span></span>
<span class="line"><span>git commit -m &quot;update&quot;</span></span>
<span class="line"><span>git remote add origin https://github.com/xinzhang-up/blog.git</span></span>
<span class="line"><span>git branch -M main</span></span>
<span class="line"><span>git push -u origin main --force</span></span></code></pre></div></li><li><p>跑脚本构建gitpage</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>sh ./vitepress-starter/deploy.sh</span></span></code></pre></div></li><li><p>在setting/pages就可以看到博客地址</p></li></ol><p><img src="`+o+'" alt="1744286196047"></p><hr><h2 id="q-a" tabindex="-1">Q&amp;A <a class="header-anchor" href="#q-a" aria-label="Permalink to &quot;Q&amp;A&quot;">​</a></h2><h3 id="q-为什么不用vuepress" tabindex="-1">Q: 为什么不用VuePress? <a class="header-anchor" href="#q-为什么不用vuepress" aria-label="Permalink to &quot;Q: 为什么不用VuePress?&quot;">​</a></h3><p>A: vuePress有大量&quot;bug&quot;, 如:</p><ul><li>目录结构要求每个文件夹下有个readme.md, 非常反人类, 我的笔记有多层级的目录结构, 十分不友好</li><li>md引用的图片仅支持与md同级文件夹的相对路径, 而使用vscode+Md Editor编辑的md文档, 图片是在image/xxx/的目录下的, 如下图, 因此我的笔记图片在vuePress上展示不出来</li></ul><p><img src="'+r+`" alt="1743941368209"></p><ul><li>尝试了多种自动生成目录的方案, 均不可行, 而vitePress更简洁, 一下子就搞定了</li></ul><h3 id="q-不支持上下标" tabindex="-1">Q: 不支持上下标? <a class="header-anchor" href="#q-不支持上下标" aria-label="Permalink to &quot;Q: 不支持上下标?&quot;">​</a></h3><p>A: 原生md语法是通过html标签来支持上下标的, 在vitePress可安装插件增强来支持, 上标为 <code>&lt;sup&gt;xx&lt;sup&gt;</code>, 下标为 <code>&lt;sub&gt;xxx&lt;sub&gt;</code>, 但vscode的Md Editor插件在编辑的时候会自动给html标签加上反引号, 会被自动改掉, 因此直接不用这个了</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm install markdown-it-sub markdown-it-sup -D</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>})</span></span></code></pre></div><h3 id="q-可以使用gitee-pages吗" tabindex="-1">Q: 可以使用Gitee Pages吗? <a class="header-anchor" href="#q-可以使用gitee-pages吗" aria-label="Permalink to &quot;Q: 可以使用Gitee Pages吗?&quot;">​</a></h3><p><img src="`+u+'" alt="1743952163833"></p>',41)]))}const k=n(d,[["render",h]]);export{x as __pageData,k as default};
